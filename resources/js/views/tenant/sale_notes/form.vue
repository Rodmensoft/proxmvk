                    ...
                    <div class="form-body">
                        <div class="row mt-1">
                            ...
                            <!-- <div class="col-lg-2 col-md-6 mt-4">
                                <div class="form-group">
                                    <label>Producto prestado?</label>
                                    <el-checkbox v-model="form.to_return" class="ml-1 mr-1" @change="changeTypeDiscount"></el-checkbox>
                                </div>
                            </div> -->
                            <!-- Pagos -->
                        ...
                        <div class="row mt-4">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr v-for="(row, index) in form.items" :key="index">
                                            <td><span class="badge text-white bg-warning" v-if="row.to_return == true || row.to_return == 1" title="Producto prestado"><i class="el-icon-info"></i></span></td>
                                            <td>{{ index + 1 }}</td>
                                            <td>
                            ...
                            <div class="col-md-12">
                                ...
                                <p class="text-right" v-if="form.total_igv > 0">IGV: {{ currency_type.symbol }}
                                    {{ form.total_igv }}</p>
                                <p class="text-right" v-if="form.total_discount > 0">DESCUENTOS TOTALES: {{
                                        currency_type.symbol
...
<script>
    ...
    methods: {
        ...
        {
            const discounts = this.form.discounts ? Object.values(this.form.discounts) : []

            if(discounts.length === 1)
            {
                if(discounts[0].is_amount !== undefined && discounts[0].is_amount !== null) this.is_amount = discounts[0].is_amount
