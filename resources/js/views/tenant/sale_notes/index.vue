            ...
            <div class="card-body">
                <data-table :resource="resource">
                    ...
                    <tr slot-scope="{ index, row }">
                        <td><span class="badge text-white bg-warning" v-if="row.to_return == true"><i class="el-icon-info"></i></span></td>
                        <td>{{ index }}</td>
                        ...
                        <td class="text-center" v-if="columns.total_pending_paid.visible">{{row.total_pending_paid}}</td>
                        <td>
